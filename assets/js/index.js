...
//     // localStorage.setItem("books", jsonTableauBook);
//     // localStorage.setItem("user", jsonTableauUser);
    
//     let otherBook = JSON.parse(jsonTableauBook);
//     let otherUser = JSON.parse(jsonTableauUser);

// /////////////////// Du JSON au JS
//     let getOtherBook = JSON.parse(localStorage.getItem("books"));
//     let getOtherUser = JSON.parse(localStorage.getItem("user"));
